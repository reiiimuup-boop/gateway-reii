...
// Endpoint 1: Generate QRIS Dinamis
...
// Endpoint 2: Cek Status Mutasi Pembayaran
app.get('/api/check-status', async (req, res) => {
  ...
  try {
    ...
    if (isPaid && email) {
      // Panggil Magic Link Alight Motion jika sudah lunas
...
app.listen(PORT, () => console.log(`Gateway Server berjalan di port ${PORT}`));
